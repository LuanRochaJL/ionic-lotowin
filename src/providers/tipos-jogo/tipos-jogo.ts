...
export default class TiposJogoProvider {
  ...
  '-F4ca/dl5/d5/L2dBISEvZ0FBIS9nQSEh/pw/Z7_HGK818G0KO6H80AU71KG7J0072/res/id=buscaResultado','#209869');

  LotoFacil = new TipoJogo('LOTOFÁCIL','lotofacil', 3, 12, 15, 18, 50, 2.00,
  ...
  'ySpRM!/dl5/d5/L2dBISEvZ0FBIS9nQSEh/pw/Z7_61L0H0G0J0VSC0AC4GLFAD2003/res/id=buscaResultado','#930089');
  ...
  '1KG7J0072/res/id=buscaResultado','#209869');
}
